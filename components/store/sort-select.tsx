  ...
  return (
    <div className="flex items-center gap-2">
      ...
      <select
        ...
        className="h-9 rounded-lg border border-input bg-background px-3 text-sm outline-none focus:border-primary focus:ring-2 focus:ring-primary/20 transition-all cursor-pointer"
      >
        {OPTIONS.map((opt) => (
