...
export default async function SoportePage() {
  ...
  const options = [
    {
      title: "Downloads y Manuales",
      desc: "Descarga manuales de usuario, fichas técnicas y actualizaciones de firmware.",
      href: "/downloads",
      icon: (
    ...
    },
    {
      ...
      desc: "Consulta las respuestas a las dudas más comunes de nuestros clientes.",
      href: "/soporte",
      icon: (
    ...
    },
    {
      ...
      desc: "Encuentra la sucursal más cercana para atención presencial.",
      href: "/donde-estamos",
      icon: (
    ...
    {
      title: "Contacto",
      desc: "Comunícate con nuestro equipo por WhatsApp, email o teléfono.",
      href: "/donde-estamos",
      icon: (
    ...
    <div className="container px-4 py-4">
      ...
      <div className="max-w-3xl mx-auto mt-8 mb-16">
        ...
        <p className="text-muted-foreground mb-10">
          Estamos para ayudarte. Elige una opción para encontrar lo que necesitas.
        </p>
