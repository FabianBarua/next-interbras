...
export default function WishlistPage() {
  ...
  return (
    <div className="space-y-6">
      <h1 className="text-2xl font-bold tracking-tight">Mi Lista de Deseos</h1>
      ...
      {wishlist.items.length === 0 ? (
        <div className="text-center py-16 border rounded-2xl bg-card space-y-4">
          ...
          <h2 className="text-xl font-bold">Sin elementos guardados</h2>
          <p className="text-muted-foreground max-w-sm mx-auto">
            Explora nuestros productos y guárdalos aquí para tus próximas compras.
          </p>
