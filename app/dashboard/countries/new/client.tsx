...
import { createCountryAction } from "@/lib/actions/admin/countries"
...
export function CountryForm() {
  ...
  const handleSubmit = () => {
    ...
    startTransition(async () => {
      const res = await createCountryAction({
        code,
  ...
  return (
    <div className="max-w-2xl space-y-6">
      ...
      <div className="flex gap-3 pt-2">
        <Button onClick={handleSubmit} disabled={isPending || !code || !nameEs || !flag || !currency}>
